...
Функция: search
    Сценарий: Добавление в стоп лист по картам
		...
		Когда пользователь (выбирает) в "дропдауне Тип сущности" значение "Номер терминала"
		Тогда на странице (присутствует) "форма Идентификатор сущности*"
		Когда пользователь (заполняет) "форму Идентификатор сущности*" значением "4000502"
