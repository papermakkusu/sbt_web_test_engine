...
Функция: search
    Сценарий: Поиск строки
		...
		Тогда на странице (присутствует) "форма № транзакции"

        Когда пользователь (заполняет) "форму № транзакции" значением "516809011049"
        Когда пользователь (кликает) "кнопку Найти"

        Тогда на странице (видна) "таблица UserForm"
        Тогда "таблица UserForm" (содержит) значение “reversed” в столбце “Reversal”